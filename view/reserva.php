...
<html>
<head>
    <title>Reservar Ingresso - <?= htmlspecialchars($filmes[$filme_id-1]->titulo) ?></title>
    ...
    <main>
        <div class="container">
            <aside>
                ...
                <div class="botoes">
                    <a href="index.php?controller=Reserva&action=alterar&filme_id=<?= $filmes[$filme_id-1]->id ?>" class="alterar">Alterar Reserva</a>
                    <a href="index.php?controller=Reserva&action=cancelar&filme_id=<?= $filmes[$filme_id-1]->id ?>" class="cancelar">Cancelar Reserva</a>
                </div>
            </aside>
            <div class="principal">
                ...
                <form method="POST" onsubmit="return validarFormulario()">
                    ...
                    <div class="cadeiras">
                        <?php foreach ($cadeiras as $c):
                            ...
                            <?php endif; ?>
                            <div class="assento">
                                <input type="checkbox" name="cadeira_id[]" value="<?= $c->id ?>" <?= in_array($c->id, $cadeirasReservadas) ? 'disabled' : '' ?>/>
                    ...
                    <div class="input-group">
                        <input type="text" name="nome" autocomplete="off" class="input" required>
